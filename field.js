class Field {
  constructor(game, side) {
    this.game = game; // Use soccer_goal.png for the goal image
    this.image = document.getElementById("soccer-goal");
    this.side = side; // Goal box size (smaller, matches the small box in the field image)
...
Game.rectsOverlap = function (a, b) {
  ...
  this.soccerBall.isStuck = Game.rectsOverlap(feetBox, ballBox); // Goal collision detection
